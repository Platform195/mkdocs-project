...
Include any relevant IDs from your internal systems in the account name for
easy cross-reference. For example: `Boots UK (SF-00123)`.

---

## Product IDs

The **Product IDs** field stores identifiers from your internal systems against
an account — Salesforce IDs, Xero references, ad-server targeting parameters,
or anything else you need to look up later. Multiple IDs can be added to a
single account.
